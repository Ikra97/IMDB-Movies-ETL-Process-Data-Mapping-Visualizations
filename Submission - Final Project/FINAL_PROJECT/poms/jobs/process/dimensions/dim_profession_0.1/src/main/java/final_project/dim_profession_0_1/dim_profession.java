...
package final_project.dim_profession_0_1;
 ...
 * @status
 */
public class dim_profession implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "dim_profession.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(dim_profession.class);
	...
	private final String jobName = "dim_profession";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					dim_profession.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(dim_profession.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class toTableStruct implements routines.system.IPersistableRow<toTableStruct> {
		final static byte[] commonByteArrayLock_FINAL_PROJECT_dim_profession = new byte[0];
		static byte[] commonByteArray_FINAL_PROJECT_dim_profession = new byte[0];
		...
		public Integer Profession_SK;

		public Integer getProfession_SK() {
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + ((this.Profession_SK == null) ? 0 : this.Profession_SK.hashCode());
		...
		public boolean equals(Object obj) {
			...
			if (this.Profession_SK == null) {
				if (other.Profession_SK != null)
					return false;

			} else if (!this.Profession_SK.equals(other.Profession_SK))
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_FINAL_PROJECT_dim_profession.length) {
					if (length < 1024 && commonByteArray_FINAL_PROJECT_dim_profession.length == 0) {
						commonByteArray_FINAL_PROJECT_dim_profession = new byte[1024];
					} else {
						commonByteArray_FINAL_PROJECT_dim_profession = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_FINAL_PROJECT_dim_profession, 0, length);
				strReturn = new String(commonByteArray_FINAL_PROJECT_dim_profession, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_FINAL_PROJECT_dim_profession, 0, length);
				strReturn = new String(commonByteArray_FINAL_PROJECT_dim_profession, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FINAL_PROJECT_dim_profession) {

				try {

					int length = 0;

					this.Profession_SK = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.Profession_SK, dos);
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "ryw5tY_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tDBOutput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBOutput_1
									.append("PASS" + " = "
											+ String.valueOf(routines.system.PasswordEncryptUtil
													.encryptPassword(context.MySqlLocal_Password)).substring(0, 4)
											+ "...");
							log4jParamters_tDBOutput_1.append(" | ");
							log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"dim_profession\"");
							log4jParamters_tDBOutput_1.append(" | ");
							...
							log4jParamters_tDBOutput_1.append(" | ");
							log4jParamters_tDBOutput_1
									.append("PROPERTIES" + " = " + "context.MySqlLocal_AdditionalParams");
							log4jParamters_tDBOutput_1.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBOutput_1", "dim_profession", "tMysqlOutput");
					talendJobLogProcess(globalMap);
				}
				...
				String tableName_tDBOutput_1 = "dim_profession";
				...
				String url_tDBOutput_1 = "jdbc:mysql://" + context.MySqlLocal_Server + ":" + context.MySqlLocal_Port
						+ "/" + context.MySqlLocal_Database + "?" + properties_tDBOutput_1;
				...
				java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(context.MySqlLocal_Database,
						null, null, new String[] { "TABLE" });
				boolean whetherExist_tDBOutput_1 = false;
				while (rsTable_tDBOutput_1.next()) {
					String table_tDBOutput_1 = rsTable_tDBOutput_1.getString("TABLE_NAME");
					if (table_tDBOutput_1.equalsIgnoreCase("dim_profession")) {
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						...
						stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
								+ "`(`Profession_SK` INT(0)  ,`Name` VARCHAR(20)  ,`DI_CreatedDate` DATETIME ,`DI_WorkflowJobId` VARCHAR(8)  ,primary key(`Profession_SK`))");
						if (log.isDebugEnabled())
				...
				String insert_tDBOutput_1 = "INSERT INTO `" + "dim_profession"
						+ "` (`Profession_SK`,`Name`,`DI_CreatedDate`,`DI_WorkflowJobId`) VALUES (?,?,?,?)";
...
// ###############################
					...
					class BytesLimit65535_tUniqRow_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tUniqRow_1.append("UNIQUE_KEY" + " = " + "[{CASE_SENSITIVE=" + ("false")
									+ ", KEY_ATTRIBUTE=" + ("true") + ", SCHEMA_COLUMN=" + ("category") + "}]");
						...
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_1
									.append("PASS" + " = "
											...
											+ "...");
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("TABLE" + " = " + "\"stg_crew_list\"");
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("QUERYSTORE" + " = " + "\"\"");
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1
									.append("QUERY" + " = " + "\"SELECT category FROM stg_crew_list;\"");
							log4jParamters_tDBInput_1.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBInput_1", "stg_crew_list", "tMysqlInput");
					talendJobLogProcess(globalMap);
				}
				...
				String url_tDBInput_1 = "jdbc:mysql://" + context.MySqlLocal_Server + ":" + context.MySqlLocal_Port
						+ "/" + context.MySqlLocal_Database + "?" + properties_tDBInput_1;
				...
				String dbquery_tDBInput_1 = "SELECT category FROM stg_crew_list;";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							...
							row1.category = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
						}
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row1", "tDBInput_1", "stg_crew_list", "tMysqlInput", "tUniqRow_1", "tUniqRow_1",
								"tUniqRow"
						...
						if (row1.category == null) {
							...
							finder_tUniqRow_1.category = row1.category.toLowerCase();
						}
						...
						if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
							...
							if (row1.category == null) {
								...
								new_tUniqRow_1.category = row1.category.toLowerCase();
							}
...
// # Output table : 'toTable'
								...
								toTable_tmp.Profession_SK = Numeric.sequence("Profession_SK", 1, 1);
								toTable_tmp.Name = row2.category;
								toTable_tmp.DI_CreatedDate = TalendDate.getCurrentDate();
								toTable_tmp.DI_WorkflowJobId = pid;
								toTable = toTable_tmp;
								log.debug("tMap_2 - Outputting the record " + count_toTable_tMap_2
...
// Start of branch "toTable"
							if (toTable != null) {
								...
								if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
										...
										, "toTable", "tMap_2", "tMap_2", "tMap", "tDBOutput_1", "dim_profession",
										"tMysqlOutput"
								...
								if (toTable.Profession_SK == null) {
									pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_1.setInt(1, toTable.Profession_SK);
								}

								if (toTable.Name == null) {
									pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(2, toTable.Name);
								}
								...
								if (toTable.DI_WorkflowJobId == null) {
									...
									pstmt_tDBOutput_1.setString(4, toTable.DI_WorkflowJobId);
								}
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row1", 2, 0,
						"tDBInput_1", "stg_crew_list", "tMysqlInput", "tUniqRow_1", "tUniqRow_1", "tUniqRow",
						"output")) {
					talendJobLogProcess(globalMap);
				}
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "toTable", 2, 0,
						"tMap_2", "tMap_2", "tMap", "tDBOutput_1", "dim_profession", "tMysqlOutput", "output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public void tPostjob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "HjoWSq_" + subJobPidCounter.getAndIncrement());
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "dTEMtX_" + subJobPidCounter.getAndIncrement());
	...
	public void tPrejob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "Q3dPxb_" + subJobPidCounter.getAndIncrement());
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "lshJdp_" + subJobPidCounter.getAndIncrement());
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "SXbwuC_" + subJobPidCounter.getAndIncrement());
	...
	public static void main(String[] args) {
		final dim_profession dim_professionClass = new dim_profession();

		int exitCode = dim_professionClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'dim_profession' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'dim_profession' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_gg8VUJEoEe6FmMo3PpyKlQ");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-12-04T04:06:16.302382300Z");
		...
		try {
			...
			java.io.InputStream inContext = dim_profession.class.getClassLoader()
					.getResourceAsStream("final_project/dim_profession_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dim_profession.class.getClassLoader()
				...
				private void processContext_0() {
					...
					if (context.getStringValue("MySqlLocal_Password") == null) {
						...
						if (pwd_MySqlLocal_Password_value != null) {
							if (context_param.containsKey("MySqlLocal_Password")) {// no need to decrypt if it come from
								...
								try {
									context.MySqlLocal_Password = routines.system.PasswordEncryptUtil
											.decryptPassword(pwd_MySqlLocal_Password_value);
					...
					if (context.getStringValue("MySqlLocal_AdditionalParams") == null) {
						...
						context.MySqlLocal_AdditionalParams = (String) context
								.getProperty("MySqlLocal_AdditionalParams");
					}
		...
		log.info("TalendJob: 'dim_profession' - Started.");
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : dim_profession");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'dim_profession' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 147267 characters generated by Talend Cloud Data Fabric on the December 3,
 * 2023 at 11:06:16 PM EST
 ************************************************************************************************/