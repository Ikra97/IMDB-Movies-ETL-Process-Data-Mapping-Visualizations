...
package final_project.dim_region_0_1;
...
public class dim_region implements TalendJob {
	static {System.setProperty("TalendJob.log", "dim_region.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(dim_region.class);
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_DANLkJE5Ee6zXrZhesgs5g", "0.1");
...
public static class toTableStruct implements routines.system.IPersistableRow<toTableStruct> {
    final static byte[] commonByteArrayLock_FINAL_PROJECT_dim_region = new byte[0];
    static byte[] commonByteArray_FINAL_PROJECT_dim_region = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_FINAL_PROJECT_dim_region.length) {
				if(length < 1024 && commonByteArray_FINAL_PROJECT_dim_region.length == 0) {
   					commonByteArray_FINAL_PROJECT_dim_region = new byte[1024];
				} else {
   					commonByteArray_FINAL_PROJECT_dim_region = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_FINAL_PROJECT_dim_region, 0, length);
			strReturn = new String(commonByteArray_FINAL_PROJECT_dim_region, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_FINAL_PROJECT_dim_region, 0, length);
			strReturn = new String(commonByteArray_FINAL_PROJECT_dim_region, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_FINAL_PROJECT_dim_region) {
...
public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "NjsH8w_" + subJobPidCounter.getAndIncrement());
...
toTableStruct toTable = new toTableStruct();
	...
	currentComponent="tDBOutput_1";
		...
		int tos_count_tDBOutput_1 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"dim_region\"");
                        log4jParamters_tDBOutput_1.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBOutput_1", "\"dim_region\"", "tMysqlOutput");
				talendJobLogProcess(globalMap);
			}
...
String tableName_tDBOutput_1 = "dim_region";
	...
	resourceMap.put("conn_tDBOutput_1", conn_tDBOutput_1);
		...
		int count_tDBOutput_1=0;
                                ...
                                while(rsTable_tDBOutput_1.next()) {
                                    ...
                                    if(table_tDBOutput_1.equalsIgnoreCase("dim_region")) {
            ...
            log.debug("tDBOutput_1 - "  + ("Creating")  + (" table '")  + (tableName_tDBOutput_1)  + ("'.") );
                                        stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1 + "`(`Region_SK` INT(0)  ,`Name` VARCHAR(20)  ,`DI_CreatedDate` DATETIME ,`DI_WorkflowJobId` VARCHAR(8)  ,primary key(`Region_SK`))");
                if(log.isDebugEnabled())
            log.debug("tDBOutput_1 - "  + ("Create")  + (" table '")  + (tableName_tDBOutput_1)  + ("' has succeeded.") );
						...
						String insert_tDBOutput_1 = "INSERT INTO `" + "dim_region" + "` (`Region_SK`,`Name`,`DI_CreatedDate`,`DI_WorkflowJobId`) VALUES (?,?,?,?)";
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tUniqRow_1{
                    ...
                    log4jParamters_tUniqRow_1.append("Parameters:");
                            log4jParamters_tUniqRow_1.append("UNIQUE_KEY" + " = " + "[{CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("region")+"}]");
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TABLE" + " = " + "\"stg_movie_releases\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERYSTORE" + " = " + "\"\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"SELECT region FROM stg_movie_releases;\"");
                        log4jParamters_tDBInput_1.append(" | ");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("region")+"}]");
                        log4jParamters_tDBInput_1.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBInput_1", "stg_movie_releases", "tMysqlInput");
				talendJobLogProcess(globalMap);
			}
	...
	final String decryptedPassword_tDBInput_1 = context.MySqlLocal_Password; 
        ...
        String url_tDBInput_1 = "jdbc:mysql://" + context.MySqlLocal_Server + ":" + context.MySqlLocal_Port + "/" + context.MySqlLocal_Database + "?" + properties_tDBInput_1;
		    ...
		    String dbquery_tDBInput_1 = "SELECT region FROM stg_movie_releases;";
        	...
        	row1.region = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
		                    }
 ...
 */
	...
	currentComponent="tUniqRow_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row1","tDBInput_1","stg_movie_releases","tMysqlInput","tUniqRow_1","tUniqRow_1","tUniqRow"
...
if(row2 != null) { 
	...
	currentComponent="tMap_2";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row2","tUniqRow_1","tUniqRow_1","tUniqRow","tMap_2","tMap_1","tMap"
...
toTable_tmp.Region_SK = Numeric.sequence("Region_SK", 1, 1);
toTable_tmp.Name = row2.region.strip().equals("\\N") ? "Missing" : row2.region;
...
if(toTable != null) { 
	...
	currentComponent="tDBOutput_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"toTable","tMap_2","tMap_1","tMap","tDBOutput_1","\"dim_region\"","tMysqlOutput"
        ...
        whetherReject_tDBOutput_1 = false;
                            if(toTable.Region_SK == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(1, toTable.Region_SK);
}
...
globalMap.put("tUniqRow_1_NB_DUPLICATES",nb_duplicates_tUniqRow_1);
	...
	log.info("tUniqRow_1 - Duplicate records count: " + (nb_duplicates_tUniqRow_1)+" .");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row1",2,0,
			 			"tDBInput_1","stg_movie_releases","tMysqlInput","tUniqRow_1","tUniqRow_1","tUniqRow","output")) {
						talendJobLogProcess(globalMap);
					}
...
// ###############################      
				log.debug("tMap_2 - Written records count in the table 'toTable': " + count_toTable_tMap_2 + ".");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row2",2,0,
			 			"tUniqRow_1","tUniqRow_1","tUniqRow","tMap_2","tMap_1","tMap","output")) {
						talendJobLogProcess(globalMap);
					}
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
            ...
            log.debug("tDBOutput_1 - "  + ("Has ")  + ("inserted")  + (" ")  + (nb_line_inserted_tDBOutput_1)  + (" record(s).") );
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"toTable",2,0,
			 			"tMap_2","tMap_1","tMap","tDBOutput_1","\"dim_region\"","tMysqlOutput","output")) {
						talendJobLogProcess(globalMap);
					}
...
public void tPrejob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "9q9Hqr_" + subJobPidCounter.getAndIncrement());
...
public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "zfQq6V_" + subJobPidCounter.getAndIncrement());
...
public void tPostjob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "sanEv1_" + subJobPidCounter.getAndIncrement());
...
public void tRunJob_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "47wLqi_" + subJobPidCounter.getAndIncrement());
...
public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "iIvcJF_" + subJobPidCounter.getAndIncrement());
 ...
 */
    ...
    public static void main(String[] args){
        ...
        int exitCode = dim_regionClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'dim_region' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
	        ...
	        getjobInfo();
			log.info("TalendJob: 'dim_region' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_DANLkJE5Ee6zXrZhesgs5g");
                org.slf4j.MDC.put("_compiledAtTimestamp","2023-12-04T02:08:30.489744500Z");
        ...
        try {
            ...
            java.io.InputStream inContext = dim_region.class.getClassLoader().getResourceAsStream("final_project/dim_region_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
        ...
        resumeUtil.addLog("JOB_STARTED", "JOB:" + jobName, parent_part_launcher, Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt));
            ...
            log.info("TalendJob: 'dim_region' - Started.");
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'dim_region' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     146802 characters generated by Talend Cloud Data Fabric 
