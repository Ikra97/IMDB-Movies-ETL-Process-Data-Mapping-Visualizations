...
package final_project.trigger_fact_load_0_1;
...
/**
 * Job: trigger_fact_load Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class trigger_fact_load implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "trigger_fact_load.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(trigger_fact_load.class);
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext() {
			...
			if (movie_job != null) {
				...
				this.setProperty("movie_job", movie_job.toString());

			}

			if (earnings_job != null) {

				this.setProperty("earnings_job", earnings_job.toString());

			}

			if (movie_job_2 != null) {

				this.setProperty("movie_job_2", movie_job_2.toString());
		...
		public String movie_job;

		public String getMovie_job() {
			return this.movie_job;
		}

		public String earnings_job;

		public String getEarnings_job() {
			return this.earnings_job;
		}

		public String movie_job_2;

		public String getMovie_job_2() {
			return this.movie_job_2;
		}
	}
	...
	private final String jobName = "trigger_fact_load";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					trigger_fact_load.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(trigger_fact_load.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tPostjob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "qjASzt_" + subJobPidCounter.getAndIncrement());
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "yo3qKK_" + subJobPidCounter.getAndIncrement());
	...
	public void tPrejob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "D4Bz07_" + subJobPidCounter.getAndIncrement());
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "fhzWtj_" + subJobPidCounter.getAndIncrement());
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "4zOhKu_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tRunJob_3 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tRunJob_3.append("PROCESS" + " = " + "fact_movie");
							log4jParamters_tRunJob_3.append(" | ");
							...
							log4jParamters_tRunJob_3.append("CONTEXTPARAMS" + " = " + "[{PARAM_NAME_COLUMN="
									+ ("job_name") + ", PARAM_VALUE_COLUMN=" + ("context.movie_job") + "}]");
							log4jParamters_tRunJob_3.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tRunJob_3", "Fact Movie", "tRunJob");
					talendJobLogProcess(globalMap);
				}
				...
				obj_tRunJob_3 = context.movie_job;
				...
				final_project.fact_movie_0_1.fact_movie childJob_tRunJob_3 = new final_project.fact_movie_0_1.fact_movie();
				// pass DataSources
				...
				log.info(
						"tRunJob_3 - The child job 'final_project.fact_movie_0_1.fact_movie' starts on the version '0.1' with the context 'Default'.");
				...
				log.info("tRunJob_3 - The child job 'final_project.fact_movie_0_1.fact_movie' is done.");
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "JQMKa0_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tRunJob_4 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tRunJob_4.append("PROCESS" + " = " + "fact_earning");
							log4jParamters_tRunJob_4.append(" | ");
							...
							log4jParamters_tRunJob_4.append("CONTEXTPARAMS" + " = " + "[{PARAM_NAME_COLUMN="
									+ ("job_name") + ", PARAM_VALUE_COLUMN=" + ("context.earnings_job") + "}]");
							log4jParamters_tRunJob_4.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tRunJob_4", "Fact Earnings", "tRunJob");
					talendJobLogProcess(globalMap);
				}
				...
				obj_tRunJob_4 = context.earnings_job;
				...
				final_project.fact_earning_0_1.fact_earning childJob_tRunJob_4 = new final_project.fact_earning_0_1.fact_earning();
				// pass DataSources
				...
				log.info(
						"tRunJob_4 - The child job 'final_project.fact_earning_0_1.fact_earning' starts on the version '0.1' with the context 'Default'.");
				...
				log.info("tRunJob_4 - The child job 'final_project.fact_earning_0_1.fact_earning' is done.");
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "boguxZ_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tRunJob_5 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tRunJob_5.append("PROCESS" + " = " + "fact_aggregation");
							log4jParamters_tRunJob_5.append(" | ");
							...
							log4jParamters_tRunJob_5.append("CONTEXTPARAMS" + " = " + "[{PARAM_NAME_COLUMN="
									+ ("job_name") + ", PARAM_VALUE_COLUMN=" + ("context.movie_job_2") + "}]");
							log4jParamters_tRunJob_5.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tRunJob_5", "Fact Aggregate", "tRunJob");
					talendJobLogProcess(globalMap);
				}
				...
				obj_tRunJob_5 = context.movie_job_2;
				...
				final_project.fact_aggregation_0_1.fact_aggregation childJob_tRunJob_5 = new final_project.fact_aggregation_0_1.fact_aggregation();
				// pass DataSources
				...
				log.info(
						"tRunJob_5 - The child job 'final_project.fact_aggregation_0_1.fact_aggregation' starts on the version '0.1' with the context 'Default'.");
				...
				log.info("tRunJob_5 - The child job 'final_project.fact_aggregation_0_1.fact_aggregation' is done.");
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "kG6Sw5_" + subJobPidCounter.getAndIncrement());
	...
	public static void main(String[] args) {
		final trigger_fact_load trigger_fact_loadClass = new trigger_fact_load();

		int exitCode = trigger_fact_loadClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'trigger_fact_load' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'trigger_fact_load' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_0fPVcJJJEe6x56qGn8mRSw");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-12-04T03:18:47.324865200Z");
		...
		try {
			...
			java.io.InputStream inContext = trigger_fact_load.class.getClassLoader()
					.getResourceAsStream("final_project/trigger_fact_load_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = trigger_fact_load.class.getClassLoader()
			...
			class ContextProcessing {
				private void processContext_0() {
					...
					context.setContextType("movie_job", "id_String");
					if (context.getStringValue("movie_job") == null) {
						context.movie_job = null;
					} else {
						context.movie_job = (String) context.getProperty("movie_job");
					}
					context.setContextType("earnings_job", "id_String");
					if (context.getStringValue("earnings_job") == null) {
						context.earnings_job = null;
					} else {
						context.earnings_job = (String) context.getProperty("earnings_job");
					}
					context.setContextType("movie_job_2", "id_String");
					if (context.getStringValue("movie_job_2") == null) {
						context.movie_job_2 = null;
					} else {
						context.movie_job_2 = (String) context.getProperty("movie_job_2");
					}
				}
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			...
			if (parentContextMap.containsKey("movie_job")) {
				context.movie_job = (String) parentContextMap.get("movie_job");
			}
			if (parentContextMap.containsKey("earnings_job")) {
				context.earnings_job = (String) parentContextMap.get("earnings_job");
			}
			if (parentContextMap.containsKey("movie_job_2")) {
				context.movie_job_2 = (String) parentContextMap.get("movie_job_2");
			}
		}
		...
		log.info("TalendJob: 'trigger_fact_load' - Started.");
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : trigger_fact_load");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'trigger_fact_load' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 104511 characters generated by Talend Cloud Data Fabric on the December 3,
 * 2023 at 10:18:47 PM EST
 ************************************************************************************************/