...
package final_project.bridge_genre_movie_0_1;
...
public class bridge_genre_movie implements TalendJob {
	...
	public static class row5Struct implements routines.system.IPersistableRow<row5Struct> {
		final static byte[] commonByteArrayLock_FINAL_PROJECT_bridge_genre_movie = new byte[0];
		static byte[] commonByteArray_FINAL_PROJECT_bridge_genre_movie = new byte[0];
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + (int) this.Genre_SK;
		...
		public boolean equals(Object obj) {
			...
			if (this.Genre_SK != other.Genre_SK)
				return false;
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_FINAL_PROJECT_bridge_genre_movie.length) {
					if (length < 1024 && commonByteArray_FINAL_PROJECT_bridge_genre_movie.length == 0) {
						commonByteArray_FINAL_PROJECT_bridge_genre_movie = new byte[1024];
					} else {
						commonByteArray_FINAL_PROJECT_bridge_genre_movie = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_FINAL_PROJECT_bridge_genre_movie, 0, length);
				strReturn = new String(commonByteArray_FINAL_PROJECT_bridge_genre_movie, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_FINAL_PROJECT_bridge_genre_movie, 0, length);
				strReturn = new String(commonByteArray_FINAL_PROJECT_bridge_genre_movie, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FINAL_PROJECT_bridge_genre_movie) {
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "yp4XXg_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBOutput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBOutput_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:NVpisXZYMCpSa6p4UdkTDJLWAimJzsQDT0Y3szkKOclC4CnU")
									.substring(0, 4) + "...");
							log4jParamters_tDBOutput_1.append(" | ");
							log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"bridge_genre_movie\"");
							log4jParamters_tDBOutput_1.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBOutput_1", "\"bridge_genre_movie\"", "tMysqlOutput");
					talendJobLogProcess(globalMap);
				}
				...
				String tableName_tDBOutput_1 = "bridge_genre_movie";
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:Oz8XMzcFyLXJY8TstOiARmxuG541wxM57Ix0vdVHgmg/qooF");
				...
				while (rsTable_tDBOutput_1.next()) {
					...
					if (table_tDBOutput_1.equalsIgnoreCase("bridge_genre_movie")) {
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						...
						stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
								+ "`(`Movie_ID` INT(0)   not null ,`Genre_SK` INT(0)   not null ,`DI_CreatedDate` DATETIME  not null ,`DI_WorkflowJobId` VARCHAR(8)   not null ,primary key(`Movie_ID`,`Genre_SK`))");
						if (log.isDebugEnabled())
				...
				String insert_tDBOutput_1 = "INSERT INTO `" + "bridge_genre_movie"
						+ "` (`Movie_ID`,`Genre_SK`,`DI_CreatedDate`,`DI_WorkflowJobId`) VALUES (?,?,?,?)";
					...
					class BytesLimit65535_tUniqRow_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tUniqRow_1.append("UNIQUE_KEY" + " = " + "[{CASE_SENSITIVE=" + ("false")
									+ ", KEY_ATTRIBUTE=" + ("false") + ", SCHEMA_COLUMN=" + ("Movie_ID")
									+ "}, {CASE_SENSITIVE=" + ("false") + ", KEY_ATTRIBUTE=" + ("false")
									+ ", SCHEMA_COLUMN=" + ("Genre_SK") + "}, {CASE_SENSITIVE=" + ("false")
...
// ###############################
					...
					class BytesLimit65535_tDBInput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:o91r98xh/8mYzEiLgXONw4U1Luse/qgr7UplFB/ptNdvNErt")
									.substring(0, 4) + "...");
							log4jParamters_tDBInput_1.append(" | ");
							...
							log4jParamters_tDBInput_1.append("QUERY" + " = "
									+ "\"SELECT    `stg_movie_details`.`tconst`,   `stg_movie_details`.`genres` FROM `stg_movie_details`\"");
							log4jParamters_tDBInput_1.append(" | ");
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:+PouCA518Cqr4+vzHhmVl5cB5b1Ghkj9EyJAnWhKJurm9tNu");
				...
				String dbquery_tDBInput_1 = "SELECT \n  `stg_movie_details`.`tconst`,\n  `stg_movie_details`.`genres`\nFROM `stg_movie_details`";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 2) {
							...
							row1.genres = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
						}
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row1", "tDBInput_1", "\"stg_movie_details\"", "tMysqlInput", "tNormalize_1",
						...
						if (row1.genres != null) {
							if ("".equals(row1.genres)) {
								normalizeRecord_tNormalize_1[0] = "";
							} else {

								normalizeRecord_tNormalize_1 = row1.genres.split(",", -1);
						...
						for (int i_tNormalize_1 = 0; i_tNormalize_1 < lastNoEmptyIndex_tNormalize_1; i_tNormalize_1++) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "row2", "tNormalize_1", "tNormalize_1", "tNormalize", "tMap_1", "tMap_1", "tMap"
							...
							if (tHash_Lookup_row3 != null && tHash_Lookup_row3.getCount(row3HashKey) > 1) { // G 071
								...
								// and it contains more one result from keys : row3.Name = '" + row3HashKey.Name
								// + "'");
							} // G 071
							...
							if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
								...
								row4HashKey.tconst = row2.tconst;
...
// # Output table : 'toTable'
								...
								toTable_tmp.Movie_ID = row4.Movie_ID;
								toTable_tmp.Genre_SK = row3.Genre_SK;
...
// Start of branch "toTable"
							if (toTable != null) {
								...
								row5.Genre_SK = toTable.Genre_SK;
...
// Start of branch "row5"
								if (row5 != null) {
									...
									if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
											...
											"\"bridge_genre_movie\"", "tMysqlOutput"
									...
									pstmt_tDBOutput_1.setInt(2, row5.Genre_SK);
									...
									if (row5.DI_WorkflowJobId == null) {
										...
										pstmt_tDBOutput_1.setString(4, row5.DI_WorkflowJobId);
									}
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row1", 2, 0,
						"tDBInput_1", "\"stg_movie_details\"", "tMysqlInput", "tNormalize_1", "tNormalize_1",
						"tNormalize", "output")) {
					talendJobLogProcess(globalMap);
				}
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row5", 2, 0,
						"tUniqRow_1", "tUniqRow_1", "tUniqRow", "tDBOutput_1", "\"bridge_genre_movie\"", "tMysqlOutput",
						"output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "R86kTg_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// linked node: tMap_1 - inputs:(row2,row4,row3) outputs:(toTable)
					...
					class BytesLimit65535_tDBInput_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_2.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:9MD1NN1UzG9oMPQ73n/iJ/0PIyhz5qkijVa3L9jVcn8VSlSO")
									.substring(0, 4) + "...");
							log4jParamters_tDBInput_2.append(" | ");
				...
				final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:VFqUmHWZ/99+xyg+alaLu6AD6CJJySKdETe38L3j+TqZzskc");
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 1) {
							...
							row4.Movie_ID = rs_tDBInput_2.getInt(1);
						...
						if (colQtyInRs_tDBInput_2 < 2) {
							...
							row4.tconst = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
						}
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row4", "tDBInput_2", "\"fact_movie\"", "tMysqlInput", "tAdvancedHash_row4",
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row4", 2, 0,
						"tDBInput_2", "\"fact_movie\"", "tMysqlInput", "tAdvancedHash_row4", "tAdvancedHash_row4",
	...
	public void tDBInput_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "RR4NPA_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBInput_3 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_3.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:2DLnCQY58z3nOIWDo17oL32b165zeSp9ubeze4YLxgsUoS0D")
									.substring(0, 4) + "...");
							log4jParamters_tDBInput_3.append(" | ");
							log4jParamters_tDBInput_3.append("TABLE" + " = " + "\"dim_genres\"");
							log4jParamters_tDBInput_3.append(" | ");
							log4jParamters_tDBInput_3.append("QUERYSTORE" + " = " + "\"\"");
							log4jParamters_tDBInput_3.append(" | ");
							log4jParamters_tDBInput_3.append("QUERY" + " = "
									+ "\"SELECT    `dim_genres`.`Genre_SK`,    `dim_genres`.`Name` FROM `dim_genres`\"");
							log4jParamters_tDBInput_3.append(" | ");
							...
							log4jParamters_tDBInput_3.append(" | ");
							log4jParamters_tDBInput_3.append(
									"TRIM_COLUMN" + " = " + "[{TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("Genre_SK")
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBInput_3", "\"dim_genres\"", "tMysqlInput");
					talendJobLogProcess(globalMap);
				}
				...
				final String decryptedPassword_tDBInput_3 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:XQS20TcIZzRDgYWU2cFfQ0P50jvbyJKDWR0HVhK40rsxbc5Q");
				...
				try {
					...
					while (rs_tDBInput_3.next()) {
						...
						if (colQtyInRs_tDBInput_3 < 1) {
							...
							row3.Genre_SK = rs_tDBInput_3.getInt(1);
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row3", "tDBInput_3", "\"dim_genres\"", "tMysqlInput", "tAdvancedHash_row3",
						...
						row3_HashRow.Genre_SK = row3.Genre_SK;
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row3", 2, 0,
						"tDBInput_3", "\"dim_genres\"", "tMysqlInput", "tAdvancedHash_row3", "tAdvancedHash_row3",
						"tAdvancedHash", "output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "U9Asz9_" + subJobPidCounter.getAndIncrement());
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_IMAu0JFJEe6zXrZhesgs5g");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-12-02T22:33:37.734926500Z");
		...
		try {
			...
			java.io.InputStream inContext = bridge_genre_movie.class.getClassLoader()
					.getResourceAsStream("final_project/bridge_genre_movie_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 190282 characters generated by Talend Cloud Data Fabric on the December 2,
 * 2023 at 5:33:37 PM EST
 ************************************************************************************************/